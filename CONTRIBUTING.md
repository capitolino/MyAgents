...
- **Instruction deduplication**: keep runner-specific command syntax in `CLAUDE.md` and `.github/copilot-instructions.md`, but place shared workflow/policy text in `docs/` and reference it (see `io-agents/framework-operating-model.md` and ADR-0001)
