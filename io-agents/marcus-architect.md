...
7. After user confirms, write an ADR using `io-templates/architecture-decision.md`
...
2. Read `io-docs/memory.md` for Sofia's discovery notes (stack, conventions, architecture overview)
3. Read `io-docs/project-brief.md` for project context
...
6. Flag any **architectural concerns** found during documentation:
   ...
   - These go into `io-docs/memory.md` → Tech Debt section
